...
public class QueryServiceForTimeSheetEmployee {

    private final ViewObjectRepository viewObjectRepository;
    private final CustomFieldRepository customFieldRepository;


    public String getIdListForGenericViewQuery(ViewDTO viewDTO,
        ...
        toMakeViewFilterQuery(viewFilter, query, ENTITY_FIELDS, customFieldMap);

        toMakeViewSorting(viewDTO, query, ENTITY_FIELDS, customFieldMap);

        return query.toString();
    }

    private void toMakeViewSorting(ViewDTO viewDTO, StringBuilder query, Map<String, Map<EntityColumnMapValuesKeyEnum, String>> ENTITY_FIELDS, Map<String, CustomField> customFieldMap) {
    ...
    private void toMakeViewFilterQuery(ViewFilterDTO viewFilter, StringBuilder query, Map<String, Map<EntityColumnMapValuesKeyEnum, String>> ENTITY_FIELDS, Map<String, CustomField> customFieldMap) {

        if ((viewFilter != null && viewFilter.getFilterFields() != null && !viewFilter.getFilterFields().isEmpty())
                || (viewFilter != null && viewFilter.getSearchingColumns() != null && !viewFilter.getSearchingColumns().isEmpty())) {

            String BASE_OPERATOR = " " + viewFilter.getFilterOperator().name() + " ";

            checkColumnsValidForFilter(ENTITY_FIELDS, customFieldMap, viewFilter);
...
//                sql = "";
            ...
            if (filterField.getFieldType().equals(CustomFieldTypeEnum.CHECKBOX)) {
            ...
            else if (filterField.getFieldType().equals(CustomFieldTypeEnum.DROPDOWN)) {
            ...
            //FIELD TURI LABEL LIK HOLATDA
                ...
                if (filterField.getCompareOperatorType().equals(ANY) ||
                    ...
                    if (filterField.isCustomField()) {
                        ...
                        //todo success
                        sql = queryEqualsForLabels(filterField.getField(),
                                filterField.getValue().getOptionsSelected(),
                                filterField.getCompareOperatorType(),
                                ENTITY_FIELDS);
                    }
                } else if (filterField.getCompareOperatorType().equals(IS_SET) ||
                        filterField.getCompareOperatorType().equals(IS_NOT_SET)) {
            ...
            //STRING BILAN ISHLAYDIGAN HAR QANDAY TYPE UCHUN
                ...
                if (filterField.getCompareOperatorType().equals(CompareOperatorTypeEnum.EQ) ||
                        filterField.getCompareOperatorType().equals(CompareOperatorTypeEnum.NOT)) {
                    ...
                    // QIDIRILYOTGAN TEXT HUMAN  TABLEDA BO'LSA
                        ...
                        Map<EntityColumnMapValuesKeyEnum, String> keyEnumStringMap = valuesKeyEnumStringMap;

                        //todo success
                        if (keyEnumStringMap.get(RELATIONAL_TABLE) == null && keyEnumStringMap.get(OTHER_TABLE) == null) {

                            sql = queryLikeOrNotEquals(filterField.getField(), filterField.getValue().getSearchingValue(), filterField.getCompareOperatorType());

                        } else if (keyEnumStringMap.get(RELATIONAL_TABLE) != null) {
            ...
            //HAR QANDAY RAQAMLIK FIELDLAR UCHUN
                ...
                if (filterField.getCompareOperatorType().equals(IS_SET) ||
                    ...
                    if (filterField.isCustomField()) {
                        ...
                        Map<EntityColumnMapValuesKeyEnum, String> mapValuesKeyEnumStringMap = valuesKeyEnumStringMap;
...
//                                // TODO HALI YOZILMAGAN ENDI YOZISH KK 10 JAN 2022
                            ...
                            if (summ.isEmpty()) {
                                sql = queryForMoneyOtherTableSumm(filterField, mapValuesKeyEnumStringMap);
                            } else if (count.isEmpty()) {
                                sql = queryForMoneyOtherTableCount(filterField, mapValuesKeyEnumStringMap);
                            }
                        }
                    }
                }
    ...
    //SEARCHING UCHUN QUERY YOZIB BERADI
    private void toMakeViewFilterSearchingQuery(ViewFilterDTO viewFilter, StringBuilder query, Map<String, Map<EntityColumnMapValuesKeyEnum, String>> ENTITY_FIELDS) {
                ...
                if (viewFilterSearchingColumnDTO.isCustomField()) {
                    ...
                    if (columnType.equals(EMAIL) ||
                        ...
                        if (valuesKeyEnumStringMap.get(RELATIONAL_TABLE) != null) {
                            ...
                            sql = queryLikeOrNotEqualsForRelationalTable(search, EQ, valuesKeyEnumStringMap);
    ...
    private String searchCustomFieldForDropDown(String columnName, String search) {
        ...
        return new StringBuilder()
                ...
                .append(" as cfdd where cast(cfdd.")
    ...
    private String searchCustomFieldForLabels(String columnName, String search) {
        ...
        return new StringBuilder()
                ...
                .append(" as cfl where (select string_to_array(cfv.")
    ...
    private String searchForLabels(String columnName, String search,
        ...
        return new StringBuilder()
                ...
                .append(" as c where c.id in (select ")
                .append(course_id)
                .append(" from ")
                .append(course_human)
                .append(" where ")
    ...
    private String queryForSort(ViewSortingDTO sortingDTO, Map<String,
        ...
        //FIELD TURI DROPDOWN BO'LGANDA QUERY YOZILADI
            ...
            } else if (sortingDTO.getField().equals(ColumnKey.BRANCH_ID)) {

                sql=sortForBranch(sortingDTO);
    ...
    private String sortForBranch(ViewSortingDTO sortingDTO) {
...
//    }
    ...
    private String sortCustomFieldForLabels(ViewSortingDTO sortingDTO) {
        ...
        return new StringBuilder()
                ...
                .append(TableNameConstant.CUSTOM_FIELD_LABEL)
                .append(" cfl ")
                .append("where (select string_to_array(cast(cfl.id as text), '')) <@(select string_to_array(cfv.value, ',')from ")
                .append(TableNameConstant.CUSTOM_FIELD_VALUE)
                .append(" as cfv ")
                .append(getCustomFieldLastWhere(sortingDTO.getField()))
    ...
    private String queryCustomFieldEqualsForLabels(String[] optionsSelected, CompareOperatorTypeEnum
        ...
        query.append("cast(g.id as varchar) in  (select cfv.")
                ...
                .append(" from ")
                .append(TableNameConstant.CUSTOM_FIELD_VALUE)
                .append(" as cfv where ((select string_to_array(cfv.value,','))");
    ...
    private String queryEqualsForLabels(String field,
...
//
    ...
    private void throwIfCompareOperatorTypeError(CustomFieldTypeEnum customFieldTypeEnum, CompareOperatorTypeEnum...
        ...
        for (FilterFieldDTO filterField : viewFilterDTO.getFilterFields()) {
            if (filterField.isCustomField()) {
                if (customFieldMap.get(filterField.getField()) == null)
                    throw RestException.restThrow("BUNDAY COLUMN YO'Q, FILTER:" + filterField.isCustomField(), HttpStatus.BAD_REQUEST);
            } else {
        ...
        for (ViewFilterSearchingColumnDTO viewFilterSearchingColumnDTO : viewFilterDTO.getSearchingColumns()) {
            if (viewFilterSearchingColumnDTO.isCustomField()) {
                if (customFieldMap.get(viewFilterSearchingColumnDTO.getColumnName()) == null)
                    throw RestException.restThrow("BUNDAY COLUMN YO'Q, SEARCHING:" + viewFilterSearchingColumnDTO.isCustomField(), HttpStatus.BAD_REQUEST);
            } else {
        ...
        for (ViewSortingDTO viewSortingDTO : viewSortingDTOList) {
            if (viewSortingDTO.isCustomField()) {
                if (customFieldMap.get(viewSortingDTO.getField()) == null)
                    throw RestException.restThrow("BUNDAY COLUMN YO'Q, SORT:" + viewSortingDTO.isCustomField(), HttpStatus.BAD_REQUEST);
            } else {

...
@RequestMapping(TariffGridViewController.GRAND_VIEW_CONTROLLER_PATH)
public interface TariffGridViewController {
    String GRAND_VIEW_CONTROLLER_PATH = RestConstants.BASE_PATH_V1 + "/tariff-grid/";
